...
//this lib is fucking great, can hide default popup recog, but we need to code that popup or something -> so I don't use in this subject
export default class TestVoice extends Component {
  constructor(props) {
    super(props);
    this.state = {
      recognized: '',
